...
class BilingualDataset(Dataset):
    def __init__(self, ds, tokenizer_src, tokenizer_tgt, src_lang, tgt_lang, seq_len):
        ...
        self.eos_token = torch.tenspr([tokenizer_tgt.token_to_id("[EOS]")], dtype = torch.int64)
    ...
    def __getitem__(self, idx):
        ...
        # Double check the size of the tensors to make sure they are all of seq_len long
